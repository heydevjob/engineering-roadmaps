...
- **Design** - architect the warehouse (senior)
...
- *Prove it:* [Make an ETL Pipeline Idempotent](../projects/data/make-an-etl-pipeline-idempotent.md) *(Harden)*
...
- *Prove it:* [Make a CSV Importer Resilient to Bad Data](../projects/data/make-a-csv-importer-resilient.md) *(Harden)*
