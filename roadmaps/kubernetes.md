[Home](../README.md) › **Kubernetes Roadmap**
...
>
> The type tags: 🔨 **Build** - author the manifest from scratch · 🔍 **Debug** - find and fix a broken object · 🛡️ **Harden** - make a workload reliable and secure · 📐 **Design** - architect for production (senior). Work top to bottom - you learn to read the failure states before you author the fixes.

```mermaid
flowchart TD
    S1["Stage 1 · Object Model &amp; Debugging Pods"] --> S2["Stage 2 · Services &amp; Networking"]
    S2 --> S3["Stage 3 · Configuration"]
    S3 --> S4["Stage 4 · Authoring Workloads"]
    S4 --> S5["Stage 5 · Health &amp; Probes"]
    S5 --> S6["Stage 6 · Rollouts &amp; Updates"]
    S6 --> S7["Stage 7 · Autoscaling"]
    S7 --> S8["Stage 8 · Packaging"]
    S8 --> S9["Stage 9 · Senior: Security &amp; Reliability"]
...
- *Prove it:* [Add Liveness and Readiness Probes](../projects/kubernetes/add-liveness-and-readiness-probes.md) *(🛡️ Harden)*
...
- *Prove it:* [Lock Down a Namespace With a NetworkPolicy](../projects/kubernetes/lock-down-a-namespace-with-networkpolicy.md) *(🛡️ Harden)*
...
- *Prove it:* [Harden a Pod With a securityContext](../projects/kubernetes/harden-a-pod-with-securitycontext.md) *(🛡️ Harden)*
...
**Explore Kubernetes** · [📍 Roadmap](kubernetes.md) · [🛠️ Projects](../projects/kubernetes/README.md) · [💬 Interview](../interview/kubernetes.md) · [✅ Checklist](../checklists/kubernetes.md)
