[Home](../README.md) › **AI/ML Interview**
...
<details>
<summary><b>What does a minimal chat completion request look like, and why do you get "model not found" or a 404 on day one?</b></summary>
...
🛠️ *Practice it live:* [Restore a Broken LLM API Integration](https://heydevjob.com/ai) (AI-101)

</details>

<details>
<summary><b>Why are LLMs called "stateless," and what does that mean for building a chatbot?</b></summary>
...
<details>
<summary><b>What's the difference between the system, user, and assistant roles?</b></summary>
...
<details>
<summary><b>An LLM is supposed to return JSON but your `json.loads()` keeps throwing. What's the most common cause and fix?</b></summary>
...
🛠️ *Practice it live:* [Parse JSON From an LLM](https://heydevjob.com/ai) (AI-104)

</details>

<details>
<summary><b>How do you make structured output more reliable beyond prompting for it?</b></summary>
...
<details>
<summary><b>Walk through the core loop of an LLM-backed API endpoint.</b></summary>
...
🛠️ *Practice it live:* [Build a Text Summarization Endpoint](https://heydevjob.com/ai) (AI-106)

</details>

## ✍️ Prompt engineering (junior to mid)

<details>
<summary><b>Your classifier is supposed to return one label but returns a paragraph of explanation. How do you fix it with the prompt alone?</b></summary>
...
🛠️ *Practice it live:* [Improve an LLM Classifier Prompt](https://heydevjob.com/ai) (AI-102)

</details>

<details>
<summary><b>What is few-shot prompting and when does it beat zero-shot?</b></summary>
...
<details>
<summary><b>What is temperature and how should you set it for different tasks?</b></summary>
...
<details>
<summary><b>How do you stop conversation history from blowing up cost and latency?</b></summary>
...
🛠️ *Practice it live:* [Add Conversation Memory to a Chatbot](https://heydevjob.com/ai) (AI-107)

</details>

<details>
<summary><b>Why stream tokens over SSE instead of returning the whole reply, and what breaks if streaming is misconfigured?</b></summary>
...
🛠️ *Practice it live:* [Restore Token Streaming on a Chat Endpoint](https://heydevjob.com/ai) (AI-109)
...
<details>
<summary><b>What is an embedding, and why does cosine similarity matter for it?</b></summary>
...
<details>
<summary><b>What does a vector database do that a regular database doesn't?</b></summary>
...
🛠️ *Practice it live:* [Power RAG Search With a Vector Database](https://heydevjob.com/ai) (AI-204)
...
<details>
<summary><b>What are the four stages of a RAG pipeline?</b></summary>
...
🛠️ *Practice it live:* [Build an End-to-End RAG Pipeline](https://heydevjob.com/ai) (AI-301)

</details>

<details>
<summary><b>Why is chunking the most under-appreciated RAG knob, and what makes a good chunk?</b></summary>
...
🛠️ *Practice it live:* [Fix the Chunking That's Wrecking RAG Retrieval](https://heydevjob.com/ai) (AI-205)

</details>

<details>
<summary><b>How does RAG reduce hallucination compared to asking the model directly?</b></summary>
...
## 🛠️ Agents and tools (mid to senior)

<details>
<summary><b>What is function (tool) calling and why use it instead of letting the model answer directly?</b></summary>
...
🛠️ *Practice it live:* [Make an LLM Pick the Right Tool](https://heydevjob.com/ai) (AI-211)

</details>

<details>
<summary><b>Describe the agent loop. What turns a model into an "agent"?</b></summary>
...
🛠️ *Practice it live:* [Build a Tool-Calling Agent Loop](https://heydevjob.com/ai) (AI-309)

</details>

<details>
<summary><b>How do you keep an agent from looping forever or going off the rails?</b></summary>
...
<details>
<summary><b>What's the cheapest meaningful win on an LLM bill, and how does it work?</b></summary>
...
🛠️ *Practice it live:* [Cut LLM Costs With Redis Caching](https://heydevjob.com/ai) (AI-203)

</details>

<details>
<summary><b>Beyond caching, what levers cut LLM cost and latency in production?</b></summary>
...
<details>
<summary><b>How do you answer "is the new prompt better than the old one" with evidence instead of vibes?</b></summary>
...
🛠️ *Practice it live:* [Build an LLM Evaluation Harness](https://heydevjob.com/ai) (AI-302)

</details>

<details>
<summary><b>What scoring methods do you use to evaluate LLM output, and what are their trade-offs?</b></summary>
...
<details>
<summary><b>Why do evals matter more for LLM features than traditional unit tests?</b></summary>
...
<details>
<summary><b>Explain overfitting and how you detect and prevent it.</b></summary>
...
<details>
<summary><b>What's the difference between precision and recall, and when do you optimize for each?</b></summary>
...
<details>
<summary><b>Why split data into train, validation, and test sets?</b></summary>
...
**Explore AI/ML** · [📍 Roadmap](../roadmaps/ai.md) · [🛠️ Projects](../projects/ai/README.md) · [💬 Interview](ai.md) · [✅ Checklist](../checklists/ai.md)
