[Home](../README.md) › **DevOps Interview**
...
<details>
<summary><b>A service won't start after a config change. Walk me through your first five minutes.</b></summary>
...
🛠️ *Practice it live:* [Recover a Crashed Linux Service](https://heydevjob.com/devops)

</details>

<details>
<summary><b>Writes started failing across the box at 3am. Where do you look?</b></summary>
...
🛠️ *Practice it live:* [Stop a Worker From Filling the Disk](https://heydevjob.com/devops)

</details>

<details>
<summary><b>What's the difference between a process getting SIGTERM and SIGKILL, and why does it matter for deploys?</b></summary>
...
<details>
<summary><b>How do you find which process is holding a port or a deleted file?</b></summary>
...
<details>
<summary><b>Service A can't reach Service B. How do you isolate whether it's DNS, routing, a firewall, or a dead listener?</b></summary>
...
<details>
<summary><b>A Node app works on localhost but is unreachable from other hosts. What's wrong?</b></summary>
...
🛠️ *Practice it live:* [Bind a Node App to 0.0.0.0](https://heydevjob.com/devops)

</details>

<details>
<summary><b>Why is "it's always DNS" a real meme and not just a joke?</b></summary>
...
<details>
<summary><b>You're getting 502 Bad Gateway but the app is confirmed up. What's happening?</b></summary>
...
🛠️ *Practice it live:* [Fix the Nginx 502 Bad Gateway](https://heydevjob.com/projects/nginx-502-bad-gateway-portfolio-project)

</details>

<details>
<summary><b>How do you reload nginx config without dropping traffic, and how is that different from a restart?</b></summary>
...
<details>
<summary><b>How does TLS work at a high level, and what's the most common cert outage?</b></summary>
...
## 🗄️ Databases in Production

<details>
<summary><b>The app is throwing "too many connections" or "remaining connection slots reserved." What's going on and how do you fix it?</b></summary>
...
🛠️ *Practice it live:* [Resolve Postgres Pool Exhaustion Under Load](https://heydevjob.com/devops)

</details>

<details>
<summary><b>What lives in pg_hba.conf and when does it bite you?</b></summary>
...
<details>
<summary><b>Why is a cache restart dangerous for your database?</b></summary>
...
<details>
<summary><b>Your Docker image is 2GB and slowing every deploy. How do you shrink it?</b></summary>
...
🛠️ *Practice it live:* [Shrink a Bloated Docker Image](https://heydevjob.com/devops)

</details>

<details>
<summary><b>What's the difference between an image and a container, and what are layers?</b></summary>
...
<details>
<summary><b>"It runs locally but not in the container." What are the usual causes?</b></summary>
...
<details>
<summary><b>Walk me through debugging a pod stuck in CrashLoopBackOff.</b></summary>
...
🛠️ *Practice it live:* [Fix a Kubernetes CrashLoopBackOff](https://heydevjob.com/kubernetes)

</details>

<details>
<summary><b>A Service returns nothing - no endpoints. What's broken?</b></summary>
...
🛠️ *Practice it live:* [Heal a Service With No Endpoints](https://heydevjob.com/kubernetes)

</details>

<details>
<summary><b>What do requests and limits do, and what happens when you set them wrong?</b></summary>
...
<details>
<summary><b>Why do readiness and liveness probes both exist?</b></summary>
...
<details>
<summary><b>terraform plan shows drift after someone hand-edited a resource during an incident, and the team wants to keep the change. What do you do?</b></summary>
...
🛠️ *Practice it live:* [Reconcile Terraform State Drift](https://heydevjob.com/devops)

</details>

<details>
<summary><b>What is Terraform state, and why is it so dangerous?</b></summary>
...
<details>
<summary><b>How do you read a Terraform plan safely before applying?</b></summary>
...
<details>
<summary><b>Compare rolling, blue-green, and canary deploys. When would you pick each?</b></summary>
...
<details>
<summary><b>A pipeline with no rollback is a loaded gun. What makes a deploy pipeline safe?</b></summary>
...
🛠️ *Practice it live:* [Automate a Node.js Deploy Pipeline With Rollback](https://heydevjob.com/devops)

</details>

<details>
<summary><b>What's the difference between continuous delivery and continuous deployment?</b></summary>
...
<details>
<summary><b>What are the three pillars of observability, and what do you alert on?</b></summary>
...
<details>
<summary><b>Production is fully down, every request is a 502, and several services are dead at once. How do you triage?</b></summary>
...
🛠️ *Practice it live:* [Triage a SEV1 Production Incident](https://heydevjob.com/devops)

</details>

<details>
<summary><b>What makes a postmortem useful, and why blameless?</b></summary>
...
## 🛡️ Senior: Reliability, Scaling & Security

<details>
<summary><b>Design a system that survives a node dying. What are the moving parts?</b></summary>
...
<details>
<summary><b>How do you rotate a secret with zero downtime?</b></summary>
...
🛠️ *Practice it live:* [Build a Versioned Secret-Rotation System](https://heydevjob.com/devops)

</details>

<details>
<summary><b>What does least privilege mean in practice, and why do most breaches start there?</b></summary>
...
**Explore DevOps** · [📍 Roadmap](../roadmaps/devops.md) · [🛠️ Projects](../projects/devops/README.md) · [💬 Interview](devops.md) · [✅ Checklist](../checklists/devops.md)
