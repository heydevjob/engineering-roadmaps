[Home](../README.md) › **Fullstack Interview**
...
## ⚛️ React & component state (junior)

<details>
<summary><b>Why does a `setCount(count + 1)` called three times in one handler only add 1?</b></summary>
...
🛠️ *Practice it live:* [Fix a React useState Stale-State Bug](https://heydevjob.com/fullstack)

</details>

<details>
<summary><b>What is a stale closure and where does it bite in async code?</b></summary>
...
<details>
<summary><b>When does React re-render a component, and why does that matter for performance?</b></summary>
...
<details>
<summary><b>What is the difference between a controlled and an uncontrolled input?</b></summary>
...
<details>
<summary><b>Why does a form submit reload the whole page and wipe React state?</b></summary>
...
🛠️ *Practice it live:* [Stop the Form From Reloading the Page on Submit](https://heydevjob.com/fullstack)

</details>

<details>
<summary><b>How do you validate a form on the client without trusting the client?</b></summary>
...
<details>
<summary><b>A React dashboard renders blank with no error. The API returns 200. What's your first move?</b></summary>
...
🛠️ *Practice it live:* [Fix a Blank React Dashboard (Failed Fetch)](https://heydevjob.com/fullstack)

</details>

<details>
<summary><b>What is CORS, and why does the fix go on the server?</b></summary>
...
🛠️ *Practice it live:* [Fix the CORS Error](https://heydevjob.com/fullstack)

</details>

<details>
<summary><b>What is a CORS preflight, and when does the browser send one?</b></summary>
...
<details>
<summary><b>How should the frontend handle a non-2xx response from `fetch`?</b></summary>
...
<details>
<summary><b>A request with a missing field returns a 500. Why is that a bug, and what should it return?</b></summary>
...
🛠️ *Practice it live:* [Return 400 on a Missing Field Instead of 500](https://heydevjob.com/fullstack)

</details>

<details>
<summary><b>When do you use 401 versus 403?</b></summary>
...
<details>
<summary><b>Why must you use parameterized queries instead of building SQL with string interpolation?</b></summary>
...
<details>
<summary><b>Walk me through a browser-to-S3 file upload.</b></summary>
...
🛠️ *Practice it live:* [Upload Files to AWS S3 From a React Form](https://heydevjob.com/fullstack)

</details>

<details>
<summary><b>Build the CRUD loop end to end - what are the layers?</b></summary>
...
🛠️ *Practice it live:* [Wire React to a Database (CRUD)](https://heydevjob.com/fullstack)

</details>

<details>
<summary><b>Where does business logic belong - the React component, the API, or the database?</b></summary>
...
## 🗃️ Data & persistence (mid to senior)

<details>
<summary><b>Why is offset pagination (`LIMIT 20 OFFSET 40`) the wrong choice for an infinite feed?</b></summary>
...
🛠️ *Practice it live:* [Implement Cursor Pagination for a Load More Feed](https://heydevjob.com/fullstack)

</details>

<details>
<summary><b>What's the N+1 query problem and how does it show up in a fullstack feature?</b></summary>
...
<details>
<summary><b>How do you keep a write idempotent so a double-submit doesn't double-charge?</b></summary>
...
<details>
<summary><b>Why is hiding a route in React not authentication?</b></summary>
...
🛠️ *Practice it live:* [Add a JWT Login and a Protected Route](https://heydevjob.com/fullstack)

</details>

<details>
<summary><b>Walk through the JWT login loop.</b></summary>
...
<details>
<summary><b>Where should you store the JWT in the browser, and what's the tradeoff?</b></summary>
...
<details>
<summary><b>Why must a JWT verifier pin the algorithm?</b></summary>
...
<details>
<summary><b>SSE works against curl but the browser sees nothing until the request ends. What's wrong?</b></summary>
...
🛠️ *Practice it live:* [Stream the AI Chat Response](https://heydevjob.com/fullstack)

</details>

<details>
<summary><b>How do you broadcast a message to every connected SSE client?</b></summary>
...
🛠️ *Practice it live:* [Build Real-Time Chat Broadcast With SSE](https://heydevjob.com/fullstack)

</details>

<details>
<summary><b>What is optimistic UI, and what's the one thing people forget?</b></summary>
...
🛠️ *Practice it live:* [Add Optimistic UI With Rollback](https://heydevjob.com/fullstack)

</details>

<details>
<summary><b>SSE vs WebSockets - when do you reach for each?</b></summary>
...
<details>
<summary><b>Design a resumable upload for large files. What are the options and how do you choose?</b></summary>
...
🛠️ *Practice it live:* [Design a Resumable Large-File Upload](https://heydevjob.com/fullstack)

</details>

<details>
<summary><b>How do you ship a feature across the stack without downtime when the database schema changes?</b></summary>
...
**Explore Fullstack** · [📍 Roadmap](../roadmaps/fullstack.md) · [🛠️ Projects](../projects/fullstack/README.md) · [💬 Interview](fullstack.md) · [✅ Checklist](../checklists/fullstack.md)
