[Home](../README.md) › **Kubernetes Interview**
...
<details>
<summary><b>A pod is in `CrashLoopBackOff`. Walk me through your first 60 seconds.</b></summary>
...
<details>
<summary><b>What does exit code 127 tell you versus exit code 1 versus 137?</b></summary>
...
<details>
<summary><b>A pod is stuck in `ImagePullBackOff`. What are the usual causes and how do you confirm?</b></summary>
...
🛠️ *Practice it live:* [Fix a Kubernetes ImagePullBackOff](https://heydevjob.com/kubernetes)

</details>

<details>
<summary><b>A pod sits in `Pending` forever. Where do you look?</b></summary>
...
🛠️ *Practice it live:* [Schedule a Pending Kubernetes Pod](https://heydevjob.com/kubernetes)

</details>

<details>
<summary><b>What's the difference between a Pod, a ReplicaSet, and a Deployment?</b></summary>
...
<details>
<summary><b>A Service is up but no traffic reaches the pods. What's your first check?</b></summary>
...
<details>
<summary><b>Explain ClusterIP, NodePort, and LoadBalancer.</b></summary>
...
<details>
<summary><b>How does a Service find its pods, and how does that decouple from pod lifecycle?</b></summary>
...
<details>
<summary><b>What does the cluster DNS name `mysvc.myns.svc.cluster.local` resolve to?</b></summary>
...
## 🗂️ Configuration & secrets (Junior → Mid)

<details>
<summary><b>A Deployment applies cleanly but the pod won't start, citing a ConfigMap. Why?</b></summary>
...
🛠️ *Practice it live:* [Reconnect a Pod to Its ConfigMap](https://heydevjob.com/kubernetes)

</details>

<details>
<summary><b>ConfigMap versus Secret - what's the real difference?</b></summary>
...
<details>
<summary><b>If you change a mounted ConfigMap, does the pod pick it up?</b></summary>
...
<details>
<summary><b>Write me a production Deployment. What goes in beyond the spec?</b></summary>
...
🛠️ *Practice it live:* [Write a Production Kubernetes Deployment](https://heydevjob.com/kubernetes)

</details>

<details>
<summary><b>Why is `image: myapp:latest` a problem in production?</b></summary>
...
<details>
<summary><b>What do resource `requests` and `limits` actually control?</b></summary>
...
<details>
<summary><b>Difference between a liveness and a readiness probe - and what breaks if you skip each?</b></summary>
...
🛠️ *Practice it live:* [Add Liveness and Readiness Probes](https://heydevjob.com/kubernetes)

</details>

<details>
<summary><b>What's a startup probe for, and why can a liveness probe alone be dangerous on a slow-starting app?</b></summary>
...
<details>
<summary><b>Walk me through a rolling update. How do you watch it and roll it back?</b></summary>
...
🛠️ *Practice it live:* [Release a New Image With a Rolling Update](https://heydevjob.com/kubernetes)

</details>

<details>
<summary><b>`maxSurge` and `maxUnavailable` - what do they trade off?</b></summary>
...
<details>
<summary><b>How does the Horizontal Pod Autoscaler decide how many replicas to run?</b></summary>
...
🛠️ *Practice it live:* [Configure an HPA for Autoscaling](https://heydevjob.com/kubernetes)

</details>

<details>
<summary><b>HPA versus VPA versus Cluster Autoscaler - which solves what?</b></summary>
...
<details>
<summary><b>Describe a Helm chart's layout and what `values.yaml` is for.</b></summary>
...
🛠️ *Practice it live:* [Write and Lint a Helm Chart](https://heydevjob.com/kubernetes)

</details>

<details>
<summary><b>Why use Helm over plain `kubectl apply -f`?</b></summary>
...
## 🛡️ Senior: networking, reliability & security

<details>
<summary><b>Kubernetes networking defaults to allow. How do you implement zero-trust, and what's the implicit-deny trick?</b></summary>
...
🛠️ *Practice it live:* [Lock Down a Namespace With a NetworkPolicy](https://heydevjob.com/kubernetes)

</details>

<details>
<summary><b>"We get 502s on every deploy." What four settings fix a zero-downtime rollout?</b></summary>
...
🛠️ *Practice it live:* [Configure a Zero-Downtime Rolling Update](https://heydevjob.com/kubernetes)

</details>

<details>
<summary><b>What goes in a hardened `securityContext`, and why does an audit ask for exactly those fields?</b></summary>
...
🛠️ *Practice it live:* [Harden a Pod With a securityContext](https://heydevjob.com/kubernetes)

</details>

<details>
<summary><b>How does Pod Security Admission work, and what are the three levels?</b></summary>
...
<details>
<summary><b>How would you give a pod least-privilege access to the Kubernetes API?</b></summary>
...
<details>
<summary><b>A namespace is stuck in `Terminating` and won't delete. What's going on?</b></summary>
...
**Explore Kubernetes** · [📍 Roadmap](../roadmaps/kubernetes.md) · [🛠️ Projects](../projects/kubernetes/README.md) · [💬 Interview](kubernetes.md) · [✅ Checklist](../checklists/kubernetes.md)
