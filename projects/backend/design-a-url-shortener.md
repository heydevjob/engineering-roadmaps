[Home](../../README.md) › [Backend Projects](README.md) › **Design a URL Shortener (System Design)**

# Design a URL Shortener (System Design)

`Backend` · `🔴 Senior` · `📐 Design` · `Ticket BE-310`

**Skills** — system design · storage · encoding
...
> [!IMPORTANT]
> **Build it for real**
> This is ticket **BE-310** on HeyDevJob - the real stubbed service above, waiting in a cloud workspace you build from your browser. Each fix lands on a portfolio you can show.
> [Design a URL Shortener on HeyDevJob →](https://heydevjob.com/backend)
...
[◀ Prev: Rename a Postgres Column With Zero Downtime](rename-a-postgres-column-zero-downtime.md) · [Next: Build an Order Saga With Compensating Actions ▶](build-an-order-saga.md)
