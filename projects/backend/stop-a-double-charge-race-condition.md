...
**Role:** Backend Engineer · **Level:** Mid · **Type:** Debug · **Skills:** concurrency, transactions, PostgreSQL
...
**Build it for real.** This is ticket **BE-204** on HeyDevJob - the real double-charge bug above, waiting in a cloud workspace you fix from your browser. Free on the junior tier, no card, no setup. [Stop a Double-Charge Race Condition on HeyDevJob →](https://heydevjob.com/backend)
