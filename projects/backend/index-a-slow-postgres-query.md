...
**Role:** Backend Engineer · **Level:** Junior · **Type:** Optimize · **Skills:** SQL, indexing, query planning
...
**Build it for real.** This is ticket **BE-115** on HeyDevJob - the real seq-scanning query above, waiting in a cloud workspace you fix from your browser. Free on the junior tier, no card, no setup. [Index a Slow Postgres Query on HeyDevJob →](https://heydevjob.com/backend)
