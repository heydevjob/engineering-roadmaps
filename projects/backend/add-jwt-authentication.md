...
**Role:** Backend Engineer · **Level:** Junior · **Type:** Build · **Skills:** JWT, authentication, FastAPI, security
...
**Build it for real.** This is ticket **BE-112** on HeyDevJob - the real open API above, waiting in a cloud workspace you secure from your browser. Free on the junior tier, no card, no setup. [Add JWT Authentication to an API on HeyDevJob →](https://heydevjob.com/projects/jwt-authentication-api-portfolio-project)
