[Home](../../README.md) › [Backend Projects](README.md) › **Rename a Postgres Column With Zero Downtime**

# Rename a Postgres Column With Zero Downtime

`Backend` · `🔴 Senior` · `🔨 Build · 📐 Design` · `Ticket BE-307`

**Skills** — migrations · zero-downtime · expand-contract · SQL
...
> [!IMPORTANT]
> **Build it for real**
> This is ticket **BE-307** on HeyDevJob - the real live-table migration above, waiting in a cloud workspace you build from your browser. Each fix lands on a portfolio you can show.
> [Rename a Postgres Column With Zero Downtime on HeyDevJob →](https://heydevjob.com/backend)
...
[◀ Prev: Stop a Double-Charge Race Condition](stop-a-double-charge-race-condition.md) · [Next: Design a URL Shortener (System Design) ▶](design-a-url-shortener.md)
