[Home](../../README.md) › [Backend Projects](README.md) › **Build an Order Saga With Compensating Actions**

# Build an Order Saga With Compensating Actions

`Backend` · `🔴 Senior` · `📐 Design` · `Ticket BE-309`

**Skills** — distributed systems · sagas · compensation
...
> [!IMPORTANT]
> **Build it for real**
> This is ticket **BE-309** on HeyDevJob - the real saga stub above, waiting in a cloud workspace you build from your browser. Each fix lands on a portfolio you can show.
> [Build an Order Saga With Compensating Actions on HeyDevJob →](https://heydevjob.com/backend)
...
[◀ Prev: Design a URL Shortener (System Design)](design-a-url-shortener.md)
