...
**Role:** Backend Engineer · **Level:** Junior · **Type:** Build · **Skills:** pagination, SQL, API design
...
**Build it for real.** This is ticket **BE-116** on HeyDevJob - the real offset-paginated endpoint above, waiting in a cloud workspace you fix from your browser. Free on the junior tier, no card, no setup. [Switch to Cursor-Based Pagination on HeyDevJob →](https://heydevjob.com/backend)
