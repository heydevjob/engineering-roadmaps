...
**Role:** Security Engineer · **Level:** Senior · **Type:** Harden · **Skills:** AWS IAM, least privilege, Terraform, cloud security
...
**Build it for real.** This is ticket **SE-305** on HeyDevJob - the real wildcard policies above, in a sandboxed AWS environment you fix from your browser. Each fix lands on a portfolio you can show. [Tighten Over-Permissive AWS IAM Policies on HeyDevJob →](https://heydevjob.com/security)
