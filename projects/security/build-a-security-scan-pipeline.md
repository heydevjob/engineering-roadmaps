[Home](../../README.md) › [Security Projects](README.md) › **Build a Security Scan Pipeline**

# Build a Security Scan Pipeline (SAST + SCA)

`Security` · `🔴 Senior` · `🔍 Audit` · `Ticket SE-301`

**Skills** — SAST · SCA · SBOM · semgrep · trivy
...
> [!IMPORTANT]
> **Build it for real**
> This is ticket **SE-301** on HeyDevJob - the real codebase with planted issues above, waiting in a cloud workspace you build the gate for from your browser. Each fix lands on a portfolio you can show.
> [Build a Security Scan Pipeline on HeyDevJob →](https://heydevjob.com/security)
...
[◀ Prev: Add Defense-in-Depth to a Public API](add-defense-in-depth-to-an-api.md) · [Next: Tighten Over-Permissive AWS IAM Policies ▶](tighten-aws-iam-policies.md)
