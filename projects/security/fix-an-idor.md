[Home](../../README.md) › [Security Projects](README.md) › **Fix an IDOR**

# Fix an IDOR Exposing Other Users' Invoices

`Security` · `🟡 Mid` · `💥 Exploit` · `Ticket SE-216`

**Skills** — broken access control · IDOR · authorization
...
> [!IMPORTANT]
> **Build it for real**
> This is ticket **SE-216** on HeyDevJob - the real enumerable endpoint above, in a cloud workspace you fix from your browser. Free on the junior tier, no card, no setup.
> [Fix an IDOR on HeyDevJob →](https://heydevjob.com/security)
...
[◀ Prev: Scrub a Secret From Git History](scrub-a-secret-from-git-history.md) · [Next: Block an SSRF in a URL Fetcher ▶](block-an-ssrf.md)
