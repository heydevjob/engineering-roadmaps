[Home](../../README.md) › [Security Projects](README.md) › **Block an SSRF**

# Block an SSRF in a URL Fetcher

`Security` · `🟡 Mid` · `🛡️ Harden` · `Ticket SE-217`

**Skills** — SSRF · network security · cloud metadata
...
> [!IMPORTANT]
> **Build it for real**
> This is ticket **SE-217** on HeyDevJob - the real SSRF-prone fetcher above, in a cloud workspace you fix from your browser. Free on the junior tier, no card, no setup.
> [Block an SSRF on HeyDevJob →](https://heydevjob.com/security)
...
[◀ Prev: Fix an IDOR Exposing Other Users' Invoices](fix-an-idor.md) · [Next: Patch the JWT None-Algorithm Bypass ▶](patch-the-jwt-none-algorithm-bypass.md)
