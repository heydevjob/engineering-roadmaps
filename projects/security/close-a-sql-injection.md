[Home](../../README.md) › [Security Projects](README.md) › **Close a SQL Injection**

# Close a SQL Injection in a Search Endpoint

`Security` · `🟢 Junior` · `💥 Exploit / 🩹 Patch` · `Ticket SE-101`

**Skills** — SQL injection · parameterized queries · Flask
...
> [!IMPORTANT]
> **Build it for real**
> This is ticket **SE-101** on HeyDevJob - the real injectable endpoint above, waiting in a cloud workspace you fix from your browser. Free on the junior tier, no card, no setup.
> [Close a SQL Injection in a Search Endpoint on HeyDevJob →](https://heydevjob.com/projects/sql-injection-fix-portfolio-project)
...
[◀ Prev: Neutralize a Stored XSS in Comments](neutralize-a-stored-xss.md) · [Next: Close a Command Injection in a Diagnostics API ▶](close-a-command-injection.md)
