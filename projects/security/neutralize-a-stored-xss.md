[Home](../../README.md) › [Security Projects](README.md) › **Neutralize a Stored XSS**

# Neutralize a Stored XSS in Comments

`Security` · `🟢 Junior` · `🩹 Patch` · `Ticket SE-102`

**Skills** — XSS · output encoding · Express
...
> [!IMPORTANT]
> **Build it for real**
> This is ticket **SE-102** on HeyDevJob - the real vulnerable comment feature above, waiting in a cloud workspace you fix from your browser. Free on the junior tier, no card, no setup.
> [Neutralize a Stored XSS in Comments on HeyDevJob →](https://heydevjob.com/security)
...
[Next: Close a SQL Injection in a Search Endpoint ▶](close-a-sql-injection.md)
