...
**Role:** Security Engineer · **Level:** Senior · **Type:** Harden · **Skills:** XSS, CSRF, cookies, JWT, secure design
...
**Build it for real.** This is ticket **SE-304** on HeyDevJob - the real localStorage-token app above, waiting in a cloud workspace you harden from your browser. Each fix lands on a portfolio you can show. [Move JWT to httpOnly Cookies on HeyDevJob →](https://heydevjob.com/security)
