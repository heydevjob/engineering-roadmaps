...
**Role:** Security Engineer · **Level:** Mid · **Type:** Patch · **Skills:** dependency scanning, SCA, CVEs, supply chain
...
**Build it for real.** This is ticket **SE-207** on HeyDevJob - the real flagged dependencies above, waiting in a cloud workspace you fix from your browser. Free on the junior tier, no card, no setup. [Patch Vulnerable npm Dependencies on HeyDevJob →](https://heydevjob.com/security)
