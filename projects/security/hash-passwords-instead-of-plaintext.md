...
**Role:** Security Engineer · **Level:** Junior · **Type:** Harden · **Skills:** password hashing, bcrypt, Flask
...
**Build it for real.** This is ticket **SE-104** on HeyDevJob - the real plaintext-password app above, waiting in a cloud workspace you fix from your browser. Free on the junior tier, no card, no setup. [Hash Passwords Instead of Storing Plaintext on HeyDevJob →](https://heydevjob.com/projects/password-hashing-bcrypt-portfolio-project)
