...
**Role:** Data Engineer · **Level:** Junior · **Type:** Harden · **Skills:** ETL, SQL, idempotency, data pipelines
...
**Build it for real.** This is ticket **DE-101** on HeyDevJob - the real duplicating pipeline above, in a cloud workspace you fix from your browser. Free on the junior tier, no card, no setup. [Make an ETL Pipeline Idempotent on HeyDevJob →](https://heydevjob.com/projects/idempotent-etl-pipeline-portfolio-project)
