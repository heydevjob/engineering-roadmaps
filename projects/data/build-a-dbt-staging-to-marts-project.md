[Home](../../README.md) › [Data Projects](README.md) › **Build a Staging-to-Marts dbt Project**

# Build a Staging-to-Marts dbt Project

`Data` · `🟡 Mid` · `🔨 Build` · `Ticket DE-206`

**Skills** — dbt · analytics engineering · SQL modeling
...
> [!IMPORTANT]
> **Build it for real**
> This is ticket **DE-206** on HeyDevJob - the real dbt scaffold above, in a cloud workspace you build from your browser. Free on the junior tier, no card, no setup.
> [Build a Staging-to-Marts dbt Project on HeyDevJob →](https://heydevjob.com/data)

**Explore Data** · [📍 Roadmap](../../roadmaps/data.md) · [🛠️ Projects](README.md) · [💬 Interview](../../interview/data.md) · [✅ Checklist](../../checklists/data.md)

[◀ Prev: Schedule a Pipeline as an Airflow DAG](schedule-a-pipeline-with-airflow.md) · [Next: Migrate a pandas Pipeline to Polars ▶](migrate-pandas-to-polars.md)
