...
- **Build** - create the pipeline or model from nothing
- **Debug** - find and fix wrong data
- **Optimize** - make it fast
- **Harden** - make it reliable and replayable
- **Design** - architect the warehouse
...
| [Make an ETL Pipeline Idempotent](make-an-etl-pipeline-idempotent.md) | DE-101 | Harden | ETL, SQL, idempotency |
| [Make a CSV Importer Resilient to Bad Data](make-a-csv-importer-resilient.md) | DE-104 | Harden | CSV, data cleaning, error handling |
