...
**Role:** Data Engineer · **Level:** Junior · **Type:** Build · **Skills:** SQL, window functions, ranking, analytics
...
**Build it for real.** This is ticket **DE-115** on HeyDevJob - the real top-N-per-group report above, in a cloud workspace you build from your browser. Free on the junior tier, no card, no setup. [Rank Rows Per Group With Window Functions on HeyDevJob →](https://heydevjob.com/projects/sql-window-functions-ranking-project)
