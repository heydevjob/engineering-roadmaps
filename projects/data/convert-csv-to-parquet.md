[Home](../../README.md) › [Data Projects](README.md) › **Convert CSV to Parquet for a Lakehouse**

# Convert CSV to Parquet for a Lakehouse

`Data` · `🟢 Junior` · `🔨 Build` · `Ticket DE-113`

**Skills** — Parquet · pyarrow · columnar formats · partitioning
...
> [!IMPORTANT]
> **Build it for real**
> This is ticket **DE-113** on HeyDevJob - the real CSV-to-Parquet task above, in a cloud workspace you build from your browser. Free on the junior tier, no card, no setup.
> [Convert CSV to Parquet for a Lakehouse on HeyDevJob →](https://heydevjob.com/data)

**Explore Data** · [📍 Roadmap](../../roadmaps/data.md) · [🛠️ Projects](README.md) · [💬 Interview](../../interview/data.md) · [✅ Checklist](../../checklists/data.md)

[◀ Prev: Make a CSV Importer Resilient to Bad Data](make-a-csv-importer-resilient.md) · [Next: Implement Incremental Loading in an ETL ▶](implement-incremental-loading.md)
