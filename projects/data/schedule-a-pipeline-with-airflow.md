[Home](../../README.md) › [Data Projects](README.md) › **Schedule a Pipeline as an Airflow DAG**

# Schedule a Pipeline as an Airflow DAG

`Data` · `🟡 Mid` · `🔨 Build` · `Ticket DE-205`

**Skills** — Airflow · DAGs · orchestration · scheduling
...
> [!IMPORTANT]
> **Build it for real**
> This is ticket **DE-205** on HeyDevJob - the real cron ETL above, in a cloud workspace you build the DAG for from your browser. Free on the junior tier, no card, no setup.
> [Schedule a Pipeline as an Airflow DAG on HeyDevJob →](https://heydevjob.com/data)

**Explore Data** · [📍 Roadmap](../../roadmaps/data.md) · [🛠️ Projects](README.md) · [💬 Interview](../../interview/data.md) · [✅ Checklist](../../checklists/data.md)

[◀ Prev: Optimize Batch Insert Throughput (COPY)](optimize-batch-insert-with-copy.md) · [Next: Build a Staging-to-Marts dbt Project ▶](build-a-dbt-staging-to-marts-project.md)
