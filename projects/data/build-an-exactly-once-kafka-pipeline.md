...
**Role:** Data Engineer · **Level:** Senior · **Type:** Design · **Skills:** Kafka, streaming, exactly-once, idempotency
...
**Build it for real.** This is ticket **DE-308** on HeyDevJob - the real streaming task above, in a cloud workspace you build from your browser. Each fix lands on a portfolio you can show. [Build an Exactly-Once Kafka Pipeline on HeyDevJob →](https://heydevjob.com/data)
