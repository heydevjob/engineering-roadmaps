[Home](../../README.md) › [Data Projects](README.md) › **Debug a Broken SQL Revenue Aggregation**

# Debug a Broken SQL Revenue Aggregation

`Data` · `🟢 Junior` · `🔍 Debug` · `Ticket DE-108`

**Skills** — SQL · joins · aggregation · reporting
...
> [!IMPORTANT]
> **Build it for real**
> This is ticket **DE-108** on HeyDevJob - the real doubled report above, in a cloud workspace you fix from your browser. Free on the junior tier, no card, no setup.
> [Debug a Broken SQL Revenue Aggregation on HeyDevJob →](https://heydevjob.com/data)

**Explore Data** · [📍 Roadmap](../../roadmaps/data.md) · [🛠️ Projects](README.md) · [💬 Interview](../../interview/data.md) · [✅ Checklist](../../checklists/data.md)

[Next: Rank Rows Per Group With Window Functions ▶](rank-rows-with-window-functions.md)
