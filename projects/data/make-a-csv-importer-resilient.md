[Home](../../README.md) › [Data Projects](README.md) › **Make a CSV Importer Resilient to Bad Data**

# Make a CSV Importer Resilient to Bad Data

`Data` · `🟢 Junior` · `🛡️ Harden` · `Ticket DE-104`

**Skills** — CSV · data cleaning · error handling · ETL
...
> [!IMPORTANT]
> **Build it for real**
> This is ticket **DE-104** on HeyDevJob - the real crashing importer above, in a cloud workspace you fix from your browser. Free on the junior tier, no card, no setup.
> [Make a CSV Importer Resilient to Bad Data on HeyDevJob →](https://heydevjob.com/data)

**Explore Data** · [📍 Roadmap](../../roadmaps/data.md) · [🛠️ Projects](README.md) · [💬 Interview](../../interview/data.md) · [✅ Checklist](../../checklists/data.md)

[◀ Prev: Make an ETL Pipeline Idempotent](make-an-etl-pipeline-idempotent.md) · [Next: Convert CSV to Parquet for a Lakehouse ▶](convert-csv-to-parquet.md)
