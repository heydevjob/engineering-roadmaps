...
**Role:** AI/ML Engineer · **Level:** Mid · **Type:** Tune · **Skills:** RAG, chunking, retrieval, embeddings
...
**Build it for real.** This is ticket **AI-205** on HeyDevJob - the real broken chunker above, in a cloud workspace you fix from your browser. Free on the junior tier, no card, no setup. [Fix the Chunking That's Wrecking RAG Retrieval on HeyDevJob →](https://heydevjob.com/ai)
