[Home](../../README.md) › [AI/ML Projects](README.md) › **Restore a Broken LLM API Integration**

# Restore a Broken LLM API Integration

`AI/ML` · `🟢 Junior` · `🔍 Debug` · `Ticket AI-101`

**Skills** — LLM APIs · OpenAI-compatible format · integration
...
> [!IMPORTANT]
> **Build it for real**
> This is ticket **AI-101** on HeyDevJob - the real broken integration above, in a cloud workspace you fix from your browser. Free on the junior tier, no card, no setup.
> [Restore a Broken LLM API Integration on HeyDevJob →](https://heydevjob.com/projects/llm-api-integration-portfolio-project)

**Explore AI/ML** · [📍 Roadmap](../../roadmaps/ai.md) · [🛠️ Projects](README.md) · [💬 Interview](../../interview/ai.md) · [✅ Checklist](../../checklists/ai.md)

[Next: Parse JSON From an LLM ▶](parse-json-from-an-llm.md)
