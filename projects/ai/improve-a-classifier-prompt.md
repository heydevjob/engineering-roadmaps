[Home](../../README.md) › [AI/ML Projects](README.md) › **Improve an LLM Classifier Prompt**

# Improve an LLM Sentiment Classifier Prompt

`AI/ML` · `🟢 Junior` · `🎯 Tune` · `Ticket AI-102`

**Skills** — prompt engineering · LLM · structured output
...
> [!IMPORTANT]
> **Build it for real**
> This is ticket **AI-102** on HeyDevJob - the real over-chatty classifier above, in a cloud workspace you fix from your browser. Free on the junior tier, no card, no setup.
> [Improve an LLM Classifier Prompt on HeyDevJob →](https://heydevjob.com/ai)

**Explore AI/ML** · [📍 Roadmap](../../roadmaps/ai.md) · [🛠️ Projects](README.md) · [💬 Interview](../../interview/ai.md) · [✅ Checklist](../../checklists/ai.md)

[◀ Prev: Build a Text Summarization Endpoint](build-a-summarization-endpoint.md) · [Next: Add Conversation Memory to a Chatbot ▶](add-conversation-memory.md)
