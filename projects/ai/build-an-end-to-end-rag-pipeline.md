...
**Role:** AI/ML Engineer · **Level:** Senior · **Type:** Build/Design · **Skills:** RAG, retrieval, embeddings, LLM
...
**Build it for real.** This is ticket **AI-301** on HeyDevJob - the real four-stage RAG stub above, in a cloud workspace you build from your browser. Each fix lands on a portfolio you can show. [Build an End-to-End RAG Pipeline on HeyDevJob →](https://heydevjob.com/ai)
