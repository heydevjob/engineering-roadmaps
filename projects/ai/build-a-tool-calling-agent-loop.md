[Home](../../README.md) › [AI/ML Projects](README.md) › **Build a Tool-Calling Agent Loop**

# Build a Tool-Calling Agent Loop

`AI/ML` · `🔴 Senior` · `📐 Design` · `Ticket AI-309`

**Skills** — agents · tool-calling · ReAct pattern · LLM
...
> [!IMPORTANT]
> **Build it for real**
> This is ticket **AI-309** on HeyDevJob - the real single-shot agent above, in a cloud workspace you build from your browser. Each fix lands on a portfolio you can show.
> [Build a Tool-Calling Agent Loop on HeyDevJob →](https://heydevjob.com/ai)

**Explore AI/ML** · [📍 Roadmap](../../roadmaps/ai.md) · [🛠️ Projects](README.md) · [💬 Interview](../../interview/ai.md) · [✅ Checklist](../../checklists/ai.md)

[◀ Prev: Build an LLM Evaluation Harness](build-an-llm-eval-harness.md)
