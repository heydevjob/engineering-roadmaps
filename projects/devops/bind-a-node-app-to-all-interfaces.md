...
**Role:** DevOps Engineer · **Level:** Junior · **Type:** Debug · **Skills:** networking, Node.js, nginx, reverse proxy
...
**Build it for real.** This is ticket **DO-104** on HeyDevJob - the real unreachable app above, waiting in a cloud workspace you fix from your browser. Free on the junior tier, no card, no setup. [Bind a Node App to 0.0.0.0 on HeyDevJob →](https://heydevjob.com/devops)
