...
**Role:** DevOps Engineer · **Level:** Senior · **Type:** Debug · **Skills:** incident response, triage, dependency chains, multi-service debugging
...
**Build it for real.** This is ticket **DO-308** on HeyDevJob - the real downed stack above, waiting in a cloud workspace you triage from your browser. Each fix lands on a portfolio you can show. [Triage a SEV1 Production Incident on HeyDevJob →](https://heydevjob.com/devops)
