...
**Role:** DevOps Engineer · **Level:** Junior · **Type:** Debug · **Skills:** nginx, reverse proxy, Linux, log reading
...
**Build it for real.** This is ticket **DO-101** on HeyDevJob - the real broken proxy above, waiting in a cloud workspace you fix from your browser. Free on the junior tier, no card, no setup. [Fix the Nginx 502 Bad Gateway on HeyDevJob →](https://heydevjob.com/projects/nginx-502-bad-gateway-portfolio-project)
