[Home](../../README.md) › [DevOps Projects](README.md) › **Stop a Worker From Filling the Disk**

# Stop a Worker From Filling the Disk

`DevOps` · `🟡 Mid` · `🔍 Debug` · `Ticket DO-205`

**Skills** — Linux · disk space · logging · log rotation
...
> [!IMPORTANT]
> **Build it for real**
> This is ticket **DO-205** on HeyDevJob - the real disk-filling worker above, waiting in a cloud workspace you fix from your browser. Free on the junior tier, no card, no setup.
> [Stop a Worker From Filling the Disk on HeyDevJob →](https://heydevjob.com/devops)
...
[◀ Prev: Shrink a Bloated Docker Image](shrink-a-bloated-docker-image.md) · [Next: Resolve Postgres Pool Exhaustion ▶](resolve-postgres-pool-exhaustion.md)
