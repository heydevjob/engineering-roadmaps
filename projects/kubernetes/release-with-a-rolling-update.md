[Home](../../README.md) › [Kubernetes Projects](README.md) › **Release a New Image With a Rolling Update**

# Release a New Image With a Rolling Update

`Kubernetes` · `🟡 Mid` · `🔨 Build` · `Ticket K8-207`

**Skills** — kubectl · deployments · rollout · rolling-update
...
> [!IMPORTANT]
> **Build it for real**
> This is ticket **K8-207** on HeyDevJob - the real Deployment to roll above, in a cloud workspace where you run kubectl from your browser. Free on the junior tier, no card, no setup.
> [Release a New Image With a Rolling Update on HeyDevJob →](https://heydevjob.com/kubernetes)
...
[◀ Prev: Add Liveness and Readiness Probes](add-liveness-and-readiness-probes.md) · [Next: Configure an HPA for Autoscaling ▶](configure-an-hpa-for-autoscaling.md)
