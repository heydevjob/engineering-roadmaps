[Home](../../README.md) › [Kubernetes Projects](README.md) › **Lock Down a Namespace With a NetworkPolicy**

# Lock Down a Namespace With a NetworkPolicy

`Kubernetes` · `🔴 Senior` · `🛡️ Harden` · `Ticket K8-303`

**Skills** — NetworkPolicy · security · zero-trust
...
> [!IMPORTANT]
> **Build it for real**
> This is ticket **K8-303** on HeyDevJob - the real wide-open namespace above, in a cloud workspace where you run kubectl from your browser. Each fix lands on a portfolio you can show.
> [Lock Down a Namespace With a NetworkPolicy on HeyDevJob →](https://heydevjob.com/kubernetes)
...
[◀ Prev: Write and Lint a Helm Chart](write-and-lint-a-helm-chart.md) · [Next: Configure a Zero-Downtime Rolling Update ▶](configure-a-zero-downtime-rolling-update.md)
