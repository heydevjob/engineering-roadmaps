[Home](../../README.md) › [Kubernetes Projects](README.md) › **Add Liveness and Readiness Probes**

# Add Liveness and Readiness Probes to a Deployment

`Kubernetes` · `🟡 Mid` · `🛡️ Harden` · `Ticket K8-208`

**Skills** — kubectl · probes · health checks · deployments
...
> [!IMPORTANT]
> **Build it for real**
> This is ticket **K8-208** on HeyDevJob - the real probe-less Deployment above, in a cloud workspace where you run kubectl from your browser. Free on the junior tier, no card, no setup.
> [Add Liveness and Readiness Probes on HeyDevJob →](https://heydevjob.com/kubernetes)
...
[◀ Prev: Write a Production Kubernetes Deployment](write-a-production-deployment.md) · [Next: Release a New Image With a Rolling Update ▶](release-with-a-rolling-update.md)
