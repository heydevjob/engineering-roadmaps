...
**Role:** Kubernetes Engineer · **Level:** Mid · **Type:** Build · **Skills:** Helm, templating, charts, values
...
**Build it for real.** This is ticket **K8-203** on HeyDevJob - the real chart scaffold above, in a cloud workspace where you run helm from your browser. Free on the junior tier, no card, no setup. [Write and Lint a Helm Chart on HeyDevJob →](https://heydevjob.com/kubernetes)
