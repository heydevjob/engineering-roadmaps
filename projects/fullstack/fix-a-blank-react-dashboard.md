[Home](../../README.md) › [Fullstack Projects](README.md) › **Fix a Blank React Dashboard (Failed Fetch)**

# Fix a Blank React Dashboard (Failed Fetch)

`Fullstack` · `🟢 Junior` · `🔍 Debug` · `Ticket FS-103`

**Skills** — React · fetch · API response shape · debugging
...
> [Fix a Blank React Dashboard on HeyDevJob →](https://heydevjob.com/projects/react-blank-dashboard-fetch-bug-project)
...
[◀ Prev: Stop the Form From Reloading on Submit](stop-the-form-reloading-on-submit.md) · [Next: Fix the CORS Error ▶](fix-the-cors-error.md)
