[Home](../../README.md) › [Fullstack Projects](README.md) › **Implement Cursor Pagination for a Load More Feed**

# Implement Cursor Pagination for a 'Load More' Feed

`Fullstack` · `🟡 Mid` · `🔨 Build` · `Ticket FS-210`

**Skills** — pagination · cursor · Flask · React · API design
...
> [!IMPORTANT]
> **Build it for real**
> This is ticket **FS-210** on HeyDevJob - the real stuck-on-page-1 feed above, waiting in a cloud workspace you fix from your browser. Free on the junior tier, no card, no setup.
> [Implement Cursor Pagination on HeyDevJob →](https://heydevjob.com/fullstack)
...
[◀ Prev: Wire React to a Database (CRUD)](wire-react-to-a-database-crud.md) · [Next: Add a JWT Login and a Protected Route ▶](add-jwt-login-and-protected-route.md)
