[Home](../../README.md) › [Fullstack Projects](README.md) › **Build Real-Time Chat Broadcast With SSE**

# Build Real-Time Chat Broadcast With Server-Sent Events

`Fullstack` · `🔴 Senior` · `🔨 Build / 📐 Design` · `Ticket FS-305`

**Skills** — SSE · real-time · pub/sub · Flask · React
...
> [!IMPORTANT]
> **Build it for real**
> This is ticket **FS-305** on HeyDevJob - the real non-broadcasting chat above, waiting in a cloud workspace you build from your browser. Each fix lands on a portfolio you can show.
> [Build Real-Time Chat Broadcast With SSE on HeyDevJob →](https://heydevjob.com/fullstack)
...
[◀ Prev: Add Optimistic UI With Rollback](add-optimistic-ui-with-rollback.md) · [Next: Design a Resumable Large-File Upload ▶](design-a-resumable-file-upload.md)
