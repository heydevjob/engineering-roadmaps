...
**Role:** Fullstack Engineer · **Level:** Senior · **Type:** Optimize · **Skills:** React, optimistic UI, rollback, UX
...
**Build it for real.** This is ticket **FS-306** on HeyDevJob - the real sluggish todo list above, waiting in a cloud workspace you fix from your browser. Each fix lands on a portfolio you can show. [Add Optimistic UI With Rollback on HeyDevJob →](https://heydevjob.com/fullstack)
