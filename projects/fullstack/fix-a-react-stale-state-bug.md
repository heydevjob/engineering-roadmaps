...
**Role:** Fullstack Engineer · **Level:** Junior · **Type:** Debug · **Skills:** React, useState, stale closures, TypeScript
...
**Build it for real.** This is ticket **FS-101** on HeyDevJob - the real stale-state counter above, waiting in a cloud workspace you fix from your browser. Free on the junior tier, no card, no setup. [Fix a React useState Stale-State Bug on HeyDevJob →](https://heydevjob.com/projects/react-usestate-stale-state-project)
