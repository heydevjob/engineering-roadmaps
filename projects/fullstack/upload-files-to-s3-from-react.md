[Home](../../README.md) › [Fullstack Projects](README.md) › **Upload Files to AWS S3 From a React Form**

# Upload Files to AWS S3 From a React Form

`Fullstack` · `🟢 Junior` · `🔨 Build` · `Ticket FS-102`

**Skills** — React · Flask · AWS S3 · boto3 · multipart
...
> [!IMPORTANT]
> **Build it for real**
> This is ticket **FS-102** on HeyDevJob - the real upload form + empty endpoint above, in a sandboxed AWS workspace you build from your browser. Free on the junior tier, no card, no setup.
> [Upload Files to AWS S3 From a React Form on HeyDevJob →](https://heydevjob.com/fullstack)
...
[◀ Prev: Return 400 on a Missing Field Instead of 500](return-400-instead-of-500.md) · [Next: Wire React to a Database (CRUD) ▶](wire-react-to-a-database-crud.md)
