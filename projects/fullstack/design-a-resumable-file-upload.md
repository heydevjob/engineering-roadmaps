[Home](../../README.md) › [Fullstack Projects](README.md) › **Design a Resumable Large-File Upload**

# Design a Resumable Large-File Upload

`Fullstack` · `🔴 Senior` · `📐 Design` · `Ticket FS-302`

**Skills** — system design · AWS S3 · multipart · resumable uploads
...
> [!IMPORTANT]
> **Build it for real**
> This is ticket **FS-302** on HeyDevJob - the real design-and-build task above, in a sandboxed AWS workspace you work from your browser. Each fix lands on a portfolio you can show.
> [Design a Resumable Large-File Upload on HeyDevJob →](https://heydevjob.com/fullstack)
...
[◀ Prev: Build Real-Time Chat Broadcast With SSE](build-realtime-chat-with-sse.md)
